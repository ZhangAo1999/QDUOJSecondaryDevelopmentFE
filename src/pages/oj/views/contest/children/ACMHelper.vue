  ...
  <panel shadow>
    ...
    <div slot="extra">
      <ul class="filter">
        ...
        <li>
          <Button :class="['ivu-btn-theme-' + theme, 'ivu-btn-ghost']" type="info" @click="getACInfo">{{$t('m.Refresh')}}</Button>
        </li>
      </ul>
    </div>
    <Table :class="'ivu-table-' + theme" :data="pagedAcInfo" :columns="columns" :loading="loadingTable" disabled-hover></Table>
