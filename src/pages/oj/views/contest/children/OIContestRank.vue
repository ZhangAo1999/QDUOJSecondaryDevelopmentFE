<template>
  <Panel shadow>
    ...
    <div slot="extra">
      ...
      <Poptip trigger="hover" placement="left-start">
        ...
        <div slot="content" id="switches">
          ...
          <p>
            <Button :class="['ivu-btn-theme-' + theme, 'ivu-btn-ghost']" type="primary" size="small" @click="downloadRankCSV">{{$t('m.download_csv')}}</Button>
          </p>
        </div>
      </Poptip>
    </div>
    ...
    <Table :class="'ivu-table-' + theme" ref="tableRank" class="auto-resize" :columns="columns" :data="dataRank" disabled-hover></Table>
