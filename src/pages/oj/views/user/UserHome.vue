        ...
        <div id="problems">
          <div v-if="problems.length">{{$t('m.List_Solved_Problems')}}
            <Poptip v-if="refreshVisible" trigger="hover" placement="right-start">
              ...
              <div slot="content">
                ...
                <Button :class="'ivu-btn-theme-' + theme" type="info" @click="freshProblemDisplayID">regenerate</Button>
              </div>
            </Poptip>
          </div>
          ...
          <div class="btns">
            <div class="problem-btn" v-for="problemID of problems" :key="problemID">
              <Button :class="'ivu-btn-theme-' + theme" type="ghost" @click="goProblem(problemID)">{{problemID}}</Button>
            </div>
          </div>
        </div>
        <div id="icons">
