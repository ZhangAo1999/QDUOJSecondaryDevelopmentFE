<template>
  <div class="flex-container">
      ...
      <Card :class="'ivu-card-' + theme" :padding="20" id="submit-code" dis-hover>
        ...
        <Row type="flex" justify="space-between">
          ...
          <Col :span="12">
            ...
            <Button :class="'ivu-btn-theme-' + theme" type="warning" icon="edit" :loading="submitting" @click="submitCode"
    ...
    <div id="right-column">
      ...
      <Card :class="'ivu-card-' + theme" id="pieChart" :padding="0" v-if="!this.contestID || OIContestRealTimePermission">
        <div slot="title">
          ...
          <Button :class="'ivu-btn-theme-' + theme" type="ghost" size="small" id="detail" @click="graphVisible = !graphVisible">Details</Button>
        </div>
        <div class="echarts">
    ...
    <Modal v-model="graphVisible">
      ...
      <div slot="footer">
        <Button :class="'ivu-btn-theme-' + theme" type="ghost" @click="graphVisible=false">{{$t('m.Close')}}</Button>
      </div>
    </Modal>
  </div>
</template>
