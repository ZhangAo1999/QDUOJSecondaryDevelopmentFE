<template>
  <Row type="flex" :gutter="18">
    ...
    <Panel shadow>
      ...
      <div slot="extra">
        <ul class="filter">
          ...
          <li>
            <Button :class="'ivu-btn-theme-' + theme" type="info" @click="onReset">
    ...
    <Panel :padding="10">
      ...
      <Button :class="'ivu-btn-theme-' + theme" v-for="tag in tagList"
              :key="tag.name"
      ...
      <Button :class="'ivu-btn-theme-' + theme" long id="pick-one" @click="pickone">
