    ...
    <div class="flex-container">
      <div class="left">
        ...
        <Form class="setting-content" ref="formPassword" :model="formPassword" :rules="rulePassword">
          ...
          <Button :class="'ivu-btn-theme-' + theme" type="primary" @click="changePassword">{{$t('m.Update_Password')}}</Button>
        </Form>
      </div>
      ...
      <div class="right">
        ...
        <Form class="setting-content" ref="formEmail" :model="formEmail" :rules="ruleEmail">
          ...
          <Button :class="'ivu-btn-theme-' + theme" type="primary" @click="changeEmail">{{$t('m.ChangeEmail')}}</Button>
        </Form>
      </div>
    </div>
  </div>
