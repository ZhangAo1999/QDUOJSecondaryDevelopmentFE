  ...
  <div class="setting-main">
    ...
    <div class="flex-container setting-content">
      <template v-for="session in sessions">
        <Card :class="'ivu-card-' + theme" :padding="20" class="flex-child">
    ...
    <div class="mini-container setting-content">
      <Form>
        ...
        <template v-if="!loadingQRcode">
          ...
          <Button :class="['ivu-btn-theme-' + theme, 'ivu-btn-ghost']" type="primary"
                  :loading="loadingBtn"
                  @click="updateTFA(false)"
                  v-if="!TFAOpened">Open TFA
          </Button>
          <Button :class="['ivu-btn-theme-' + theme, 'ivu-btn-ghost']" type="error"
                  :loading="loadingBtn"
                  @click="closeTFA"
                  v-else>Close TFA
          </Button>
