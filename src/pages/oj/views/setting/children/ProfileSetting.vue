<template>
  <div class="setting-main">
    ...
    <template v-else>
      <div class="flex-container">
        ...
        <ButtonGroup vertical class="cropper-btn">
          <Button :class="'ivu-btn-theme-' + theme" @click="rotate('left')">
            <Icon type="arrow-return-left" size="20"></Icon>
          </Button>
          <Button :class="'ivu-btn-theme-' + theme" @click="rotate('right')">
            <Icon type="arrow-return-right" size="20"></Icon>
          </Button>
          <Button :class="'ivu-btn-theme-' + theme" @click="reselect">
            <Icon type="refresh" size="20"></Icon>
          </Button>
          <Button :class="'ivu-btn-theme-' + theme" @click="finishCrop">
    ...
    <Modal v-model="uploadModalVisible"
      ...
      <div slot="footer">
        <Button :class="'ivu-btn-theme-' + theme" @click="uploadAvatar" :loading="loadingUploadBtn">upload</Button>
      </div>
    </Modal>
    ...
    <Form ref="formProfile" :model="formProfile">
      <Row type="flex" :gutter="30" justify="space-around">
        <Col :span="11">
          ...
          <Form-item>
            <Button :class="'ivu-btn-theme-' + theme" type="primary" @click="updateProfile" :loading="loadingSaveBtn">Save All</Button>
          </Form-item>
        </Col>
