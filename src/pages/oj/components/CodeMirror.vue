    ...
    <Row type="flex" justify="space-between" class="header">
      ...
      <div>
        ...
        <Tooltip :content="this.$i18n.t('m.Reset_to_default_code_definition')" placement="top" style="margin-left: 10px">
          <Button :class="['ivu-btn-theme-' + theme, 'ivu-btn-ghost']" icon="refresh" @click="onResetClick"></Button>
        </Tooltip>

        <Tooltip :content="this.$i18n.t('m.Upload_file')" placement="top" style="margin-left: 10px">
          <Button :class="['ivu-btn-theme-' + theme, 'ivu-btn-ghost']" icon="upload" @click="onUploadFile"></Button>
        </Tooltip>
...
<script>
  ...
  import 'codemirror/addon/hint/csrc-hint.js'
  import 'codemirror/addon/hint/c++src-hint.js'
